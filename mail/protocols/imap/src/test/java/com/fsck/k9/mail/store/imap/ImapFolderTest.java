...
public class ImapFolderTest {
    ...
    public void getUidFromMessageId_withMessageIdHeader_shouldIssueUidSearchCommand() throws Exception {
        ...
        folder.getUidFromMessageId("<00000000.0000000@fsck.org>");

        assertCommandIssued("UID SEARCH HEADER MESSAGE-ID \"<00000000.0000000@fsck.org>\"");
    }
    ...
    public void getUidFromMessageId() throws Exception {
        ...
        String uid = folder.getUidFromMessageId("<00000000.0000000@fsck.org>");
