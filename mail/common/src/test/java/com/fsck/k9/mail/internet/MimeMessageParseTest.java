...
public class MimeMessageParseTest {
    ...
    public void testSinglePart7BitNoRecurse() throws Exception {
        ...
        checkAddresses(msg.getFrom(), "adam@fsck.org");
        checkAddresses(msg.getRecipients(RecipientType.TO), "eva@fsck.org");
    ...
    public void headerFieldNameWithSpace() throws Exception {
        ...
        assertEquals("<adam@fsck.org>", msg.getHeader("From")[0]);
    }
    ...
    public void testMultipartSingleLayerNoRecurse() throws Exception {
        ...
        checkAddresses(msg.getFrom(), "x@fsck.org");
        checkAddresses(msg.getRecipients(RecipientType.TO), "y@fsck.org");
