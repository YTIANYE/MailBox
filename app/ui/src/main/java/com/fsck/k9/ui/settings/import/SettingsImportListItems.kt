...
import kotlinx.android.synthetic.main.settings_import_account_list_item.*//Kotlin Android Extensions 的主要功能其实就是视图绑定
...
class AccountItem(account: SettingsListItem.Account) :
    ...
    override fun bindView(holder: ImportCheckBoxViewHolder, payloads: MutableList<Any>) {
        super.bindView(holder, payloads)
        holder.accountDisplayName.text = displayName//Kotlin Android Extensions 的主要功能其实就是视图绑定
    }
}
