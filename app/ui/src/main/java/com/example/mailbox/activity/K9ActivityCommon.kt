...
import com.example.mailbox.activity.misc.SwipeGestureDetector
import com.example.mailbox.ui.Theme
...
class K9ActivityCommon(
     ...
     */
    fun setupGestureDetector(listener: SwipeGestureDetector.OnSwipeGestureListener) {
