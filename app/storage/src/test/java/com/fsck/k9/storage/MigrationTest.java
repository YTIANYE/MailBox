...
public class MigrationTest extends K9RobolectricTest {
    ...
    private void insertMultipartAlternativeMessage(SQLiteDatabase db) {
        String[] statements = new String[] {
                "INSERT INTO messages VALUES(8,0,16,'9','mail with html multipart',1453922449000," +
                        "'X_GOT_ALL_HEADERS,X_DOWNLOADED_FULL','jh@fsck.org;','look@my.amazin.horse'," +
                        "'','','','<html>\n" +
                        "  <head>\n" +
                        "\n" +
                        ...
                        "',0,1453922455000,'<56A91891.7010509@fsck.org>'," +
                ...
                "INSERT INTO headers (message_id, name, value) VALUES (8,'From','=?UTF-8?Q?Jan_H=c3=benbecker?= <jh@fsck.org>')",
                "INSERT INTO headers (message_id, name, value) VALUES (8,'Subject','mail with html multipart')",
                "INSERT INTO headers (message_id, name, value) VALUES (8,'Message-ID','<56A91891.7010509@fsck.org>')",
    ...
    private void insertHtmlWithRelatedMessage(SQLiteDatabase db) {
        String[] statements = new String[] {
                "INSERT INTO messages VALUES(9,0,16,'10','html with multipart/related content',1453922845000," +
                        ...
                        "\n" +
                        "Alternative_Text\n" +
                        "',1,1453922852000,'<56A91A1D.7050908@fsck.org>','html text with inline attachment Alternative_Text','multipart/alternative',NULL,0,1,0,0,0);\n",

                "INSERT INTO headers (message_id, name, value) VALUES(9,'Return-Path','<jh@fsck.org>')",
                ...
                "INSERT INTO headers (message_id, name, value) VALUES(9,'From','=?UTF-8?Q?Jan_H=c3=benbecker?= <jh@fsck.org>')",
                "INSERT INTO headers (message_id, name, value) VALUES(9,'Subject','html with multipart/related content')",
                "INSERT INTO headers (message_id, name, value) VALUES(9,'Message-ID','<56A91A1D.7050908@fsck.org>')",
                ...
                "INSERT INTO attachments VALUES(6,9,NULL,'content://com.fsck.k9.attachmentprovider/" + account.getUuid() + "/6/RAW'," +
                        "8503,'attached.jpg','image/jpeg','part1.07090108.09020601@fsck.org','inline')",
        };
    ...
    public void migrateHtmlWithRelatedMessage() throws Exception {
        ...
        Assert.assertTrue(msgTextContent.contains("cid:part1.07090108.09020601@fsck.org"));
    ...
    private Account getNewAccount() {
        ...
        account.setStoreUri("imap+tls+://user:password@imap.fsck.org");
        return account;
    }
}
