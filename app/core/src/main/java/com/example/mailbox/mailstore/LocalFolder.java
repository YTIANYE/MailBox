...
import com.example.mailbox.helper.FileHelper;
...
import com.example.mailbox.mail.filter.CountingOutputStream;
...
import com.example.mailbox.mail.internet.SizeAware;
import com.example.mailbox.mail.message.MessageHeaderParser;
...
import com.example.mailbox.message.extractors.PreviewResult.PreviewType;
...
public class LocalFolder extends Folder<LocalMessage> {
     ...
     * {@link com.example.mailbox.controller.MessagingController#shouldNotifyForMessage} to see if messages being
