...
import com.example.mailbox.mail.internet.Viewable;
import com.example.mailbox.mail.internet.Viewable.Flowed;
import com.example.mailbox.mailstore.CryptoResultAnnotation.CryptoError;
import com.example.mailbox.mailstore.util.FlowedMessageUtils;
...
import com.example.mailbox.message.html.HtmlProcessor;
import org.openintents.openpgp.util.OpenPgpUtils;
import timber.log.Timber;

import static com.example.mailbox.mail.internet.MimeUtility.getHeaderParameter;
import static com.example.mailbox.mail.internet.Viewable.Alternative;
import static com.example.mailbox.mail.internet.Viewable.Html;
import static com.example.mailbox.mail.internet.Viewable.MessageHeader;
import static com.example.mailbox.mail.internet.Viewable.Text;
import static com.example.mailbox.mail.internet.Viewable.Textual;
...
public class MessageViewInfoExtractor {
     ...
     *
     * @throws com.example.mailbox.mail.MessagingException
     *          In case of an error.
     */
    @VisibleForTesting
    ...
    /**
     * Use the contents of a {@link com.example.mailbox.mail.internet.Viewable} to create the HTML to be displayed.
     *
     * <p>
