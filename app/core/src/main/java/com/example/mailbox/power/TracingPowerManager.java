package com.example.mailbox.power;
...
public class TracingPowerManager implements com.example.mailbox.mail.power.PowerManager {
    ...
    @NotNull
    @Override
    public com.example.mailbox.mail.power.WakeLock newWakeLock(@NotNull String tag) {
    ...
    public class TracingWakeLock implements com.example.mailbox.mail.power.WakeLock {
