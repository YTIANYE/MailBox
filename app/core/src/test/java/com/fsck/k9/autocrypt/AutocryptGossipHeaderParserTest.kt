...
class AutocryptGossipHeaderParserTest {
    ...
    val GOSSIP_HEADER_BOB = """addr=bob@autocrypt.fsck; keydata=
 mQGNBFoBt74BDAC8AMsjPY17kxodbfmHah38ZQipY0yfuo97WUBs2jeiFYlQdunPANi5VMgbAX+H
 Mq1XoBRs6qW+WpX8Uj11mu22c57BTUXJRbRr4TnTuuOQmT0egwFDe3x8vHSFmcf9OzG8iKR9ftUE
...
Autocrypt-Gossip: addr=carol@autocrypt.fsck; keydata=
...
""".replace("\n", "\r\n")
    ...
    fun parseFromPart() {
        ...
        assertEquals("bob@autocrypt.fsck", allAutocryptGossipHeaders[0].addr)
        assertEquals("carol@autocrypt.fsck", allAutocryptGossipHeaders[1].addr)
