...
class TextQuoteCreatorTest : RobolectricTest() {
    ...
    val originalMessage = mock<Message> {
        ...
        on { from } doReturn Address.parse("Alice <alice@sender.fsck>")
        on { getRecipients(RecipientType.TO) } doReturn Address.parse("bob@recipient.fsck")
    ...
    fun prefixQuote() {
        ...
        assertThat(quote).isEqualTo("""
            On January 18, 1970 7:53:41 PM UTC, Alice <alice@sender.fsck> wrote:
            > Line 1
            > Line 2
            > Line 3
            """.trimIndent().crlf())
    ...
    fun headerQuote() {
        ...
        assertThat(quote).isEqualTo("""
            ...
            -------- Original Message --------
            From: Alice <alice@sender.fsck>
            Sent: January 18, 1970 7:53:41 PM UTC
            To: bob@recipient.fsck
