...
public class LockScreenNotificationTest extends RobolectricTest {
    ...
    public void configureLockScreenNotification_SENDERS_withSingleMessage() throws Exception {
        ...
        String senderName = "alice@fsck.com";
    ...
    public void configureLockScreenNotification_SENDERS_withMultipleMessages() throws Exception {
        K9.setLockScreenNotificationVisibility(LockScreenNotificationVisibility.SENDERS);
        NotificationContent content1 = createNotificationContent("alice@fsck.com");
        NotificationContent content2 = createNotificationContent("Bob <bob@fsck.com>");
        NotificationContent content3 = createNotificationContent("\"Peter Lustig\" <peter@fsck.com>");
        ...
        verify(publicBuilder).setContentText(
                "alice@fsck.com, Bob <bob@fsck.com>, \"Peter Lustig\" <peter@fsck.com>");
        verify(builder).setPublicVersion(publicBuilder.build());
    }
    ...
    public void createCommaSeparatedListOfSenders_withMoreSendersThanShouldBeDisplayed() throws Exception {
        NotificationContent content1 = createNotificationContent("alice@fsck.com");
        NotificationContent content2 = createNotificationContent("bob@fsck.com");
        NotificationContent content3 = createNotificationContent("cloe@fsck.com");
        NotificationContent content4 = createNotificationContent("dagobert@fsck.com");
        NotificationContent content5 = createNotificationContent("ed@fsck.com");
        NotificationContent content6 = createNotificationContent("fiona@fsck.com");
        ...
        assertEquals(
                "alice@fsck.com, bob@fsck.com, cloe@fsck.com, dagobert@fsck.com, ed@fsck.com", result);
    }
