...
public class ReplyToParserTest extends RobolectricTest {
    private static final Address[] REPLY_TO_ADDRESSES = Address.parse("replyTo1@fsck.com, replyTo2@fsck.com");
    private static final Address[] LIST_POST_ADDRESSES = Address.parse("listPost@fsck.com");
    private static final Address[] FROM_ADDRESSES = Address.parse("from@fsck.com");
    private static final Address[] TO_ADDRESSES = Address.parse("to1@fsck.com, to2@fsck.com");
    private static final Address[] CC_ADDRESSES = Address.parse("cc1@fsck.com, cc2@fsck.com");
