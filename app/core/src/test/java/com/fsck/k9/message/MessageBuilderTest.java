...
public class MessageBuilderTest extends RobolectricTest {
    ...
    private static final Address TEST_IDENTITY_ADDRESS = new Address("test@fsck.org", "tester");
    private static final Address[] TEST_TO = new Address[] {
            new Address("to1@fsck.org", "recip 1"),
            new Address("to2@fsck.org", "recip 2")
    };
    private static final Address[] TEST_CC = new Address[] {
            new Address("cc@fsck.org", "cc recip") };
    private static final Address[] TEST_BCC = new Address[] {
            new Address("bcc@fsck.org", "bcc recip") };
    private static final String TEST_MESSAGE_ID = "<00000000-0000-007B-0000-0000000000EA@fsck.org>";
    ...
    private static final String MESSAGE_HEADERS = "" +
            ...
            "From: tester <test@fsck.org>\r\n" +
            "To: recip 1 <to1@fsck.org>, recip 2 <to2@fsck.org>\r\n" +
            "CC: cc recip <cc@fsck.org>\r\n" +
            "BCC: bcc recip <bcc@fsck.org>\r\n" +
